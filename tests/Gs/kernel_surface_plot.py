    ...
    for i in range(0, len(list_G), 1):
        for j in range(0, len(list_G[0]), 1):
            ...
            if(i==0 or i==1):
                ...
                ax[i,j].plot(Rppqb11, Ippqb11, marker='o',markerfacecolor="red", markersize=5, color="black",linestyle='none', markeredgewidth=2)
                ax[i,j].plot(Rpmqb11, Ipmqb11, marker='o',markerfacecolor="red", markersize=5, color="black",linestyle='none', markeredgewidth=2)
            else:
                ax[i,j].plot(Rqb2[0], Iqb2[0], marker='o',markerfacecolor="darkorange", markersize=10, color="black",linestyle='none', markeredgewidth=2)
                ax[i,j].plot(-Rqb2[0], -Iqb2[0], marker='o',markerfacecolor="darkorange", markersize=10, color="black",linestyle='none', markeredgewidth=2)

                ax[i,j].plot(Rppqb2, Ippqb2, marker='o',markerfacecolor="red", markersize=5, color="black",linestyle='none', markeredgewidth=2)
                ax[i,j].plot(Rpmqb2, Ipmqb2, marker='o',markerfacecolor="red", markersize=5, color="black",linestyle='none', markeredgewidth=2)
