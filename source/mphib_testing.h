...
//This version uses 2 different epsilons, the epsilon
//that is input for GS depends on the spectator that is
//latched to the j index. 
void negative_GSpqb_mat_1(    Eigen::MatrixXcd &negGpqb_mat,
                            comp En,
                            std::vector<comp> &pvec_for_m1m2, 
                            std::vector<comp> &kvec_for_m1m1,
                            std::vector<comp> &weights_for_pvec_for_m1m2, 
                            ...
                            comp total_P )
{
    ...
    {
        comp p = pvec_for_m1m2[i];
        comp G = GS_pk(En, p, qb, mi, mj, mk, eps_for_ope_1, eps_for_cutoff_1);
    ...
    {
        comp p = pvec_for_m1m2[i];
        comp G = GS_pk(En, p, qb, mi, mj, mk, eps_for_ope_2, eps_for_cutoff_2);
...
//This is not used anymore, use the next iteration
...
//this depend on the two-body symmetry factor
//This does not solve our problem and still shows 
//plateaued error
void test_dpqb_solver_ERE_1(   Eigen::MatrixXcd &dmatpqb,
                        comp En,
                        double m1, 
                        double m2, 
                        std::vector<comp> &pvec_m1m2,
...
//This version uses 2 epsilons for the two-body subchannels
//ope and cutoff 
void test_dpqb_solver_ERE_2(   Eigen::MatrixXcd &dmatpqb,
                        comp En,
                        double m1, 
                        double m2, 
                        std::vector<comp> &pvec_m1m2,
                        ...
                        char debug    )
{
    ...
    test_Bmat_2plus1_system_ERE_2( B_mat, En, pvec_for_m1m2, kvec_for_m1m1, weights_for_pvec_for_m1m2, weights_for_kvec_for_m1m1, m1, m2, eps_for_m2k_1, eps_for_m2k_2, eps_for_ope_1, eps_for_ope_2, eps_for_cutoff_1, eps_for_cutoff_2, total_P, a0_m1, r0_m1, eta_1, a0_m2, r0_m2, eta_2 );
    //std::cout<<"here"<<std::endl; 
    //std::cout<<"Bmat 1 determinant = "<<B_mat.determinant()<<std::endl;
    ...
    negative_GSpqb_mat_1(negG_mat, En, pvec_for_m1m2, kvec_for_m1m1, weights_for_pvec_for_m1m2, weights_for_kvec_for_m1m1, qb_val, m1, m2, eps_for_ope_1, eps_for_ope_2, eps_for_cutoff_1, eps_for_cutoff_2, total_P);
    //std::cout<<"here"<<std::endl; 
...
//This does not solve our problem and still shows 
//plateaued error
void test_dqq_interpolator_1(   Eigen::MatrixXcd &result_dqbqb_mat,
                                Eigen::MatrixXcd &dpqb_mat, 
                                comp En,
                                double m1, 
                                double m2, 
                                ...
                                char debug    )
{
    ...
    Eigen::MatrixXcd temp_mat_op = WG_mat*M2k_mat*dpqb_mat;
    result_dqbqb_mat = negGqbqb_mat - temp_mat_op; 
...
//This version uses two different epsilons for M2k, Gs and H
void test_dqq_interpolator_2(   Eigen::MatrixXcd &result_dqbqb_mat,
                                Eigen::MatrixXcd &dpqb_mat, 
                                comp En,
                                double m1, 
                                double m2, 
                                ...
                                char debug    )
{
    ...
    comp G = GS_pk(En, qb, qb, mi, mj, mk, eps_for_ope_1, eps_for_cutoff_1);
    ...
    G = GS_pk(En, qb, qb, mi, mj, mk, eps_for_ope_2, eps_for_cutoff_2);
    ...
    G = GS_pk(En, qb, qb, mi, mj, mk, eps_for_ope_1, eps_for_cutoff_1);
    ...
    {
        comp p = pvec_for_m1m2[i];
        comp M2k = M2k_ERE(eta_1, En, p, total_P, a0_m1, r0_m1, mi, mj, mk, eps_for_m2k_1);
        M2k_m1m2(i,i) = M2k; 
    }
    ...
    {
        comp k = kvec_for_m1m1[i]; 
        comp M2k = M2k_ERE(eta_2, En, k, total_P, a0_m2, r0_m2, mi, mj, mk, eps_for_m2k_2);
        M2k_m1m1(i,i) = M2k; 
    }
    ...
    for(int i=0; i<size1; ++i)
    {
        ...
        comp G = GS_pk(En, qb, k, mi, mj, mk, eps_for_ope_1, eps_for_cutoff_1);
        comp W = weights*k*k/(pow(2.0*pi,2.0)*omgk);
        WG_11(0,i) = W*G; 
    }
    ...
    for(int i=0; i<size2; ++i)
    {
        ...
        comp G = GS_pk(En, qb, k, mi, mj, mk, eps_for_ope_2, eps_for_cutoff_2);
        comp W = weights*k*k/(pow(2.0*pi,2.0)*omgk);
        WG_12(0,i) = W*G; 
    }
